...
import jp.co.internous.ecsite01.model.form.GoodsForm;
...
public class AdminController {
	...
	public String addGoods(GoodsForm goodsForm, LoginForm loginForm, Model m) {
		...
		return "forward:/ecsite01/admin/welcome";		
	}
